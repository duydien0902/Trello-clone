...
const UserPage = () => {
  ...
  // For multiple forms in only one page: https://stackoverflow.com/a/60277873/8324172
  ...
  const handleSelectTab = (selectedTab) => {
    const searchPatch = `?${createSearchParams({ tab: selectedTab })}`
    navigate({ search: searchPatch })
  }
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        content="Do you want to sigh-out?"
      />
    </>
  )
}
