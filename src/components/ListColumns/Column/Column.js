...
function Column(props) {
  ...
  /**
   * Dùng flushSync ở hàm onColumnDrop kết hợp với Dùng useLayoutEffect ở vài chỗ xử lý mấy cái UI giật giật. Cụ thể dùng trong File Column.js
   * https://www.codestus.com/posts/truong-hop-useeffect-va-uselayouteffect-nhu-the-nao
   */
  useLayoutEffect(() => {
        ...
        <div className="column-title">
          <Form className="common__form">
            <Form.Control
              ...
              // bỏ cái onMouseDown bên dưới nếu muốn click title hiện con trỏ chứ không bôi đen nữa.
